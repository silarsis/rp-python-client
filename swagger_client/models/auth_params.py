...
class AuthParams(object):
    ...
    def __init__(self, username=None, password=None):
        """
        AuthParams - a model defined in Swagger
    ...
    def username(self):
        """
        Gets the username of this AuthParams.
        Username for access

        :return: The username of this AuthParams.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this AuthParams.
        Username for access

        :param username: The username of this AuthParams.
        :type: str
        """
        if username is None:
    ...
    def password(self):
        """
        Gets the password of this AuthParams.
        Password for access

        :return: The password of this AuthParams.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this AuthParams.
        Password for access

        :param password: The password of this AuthParams.
        :type: str
        """
        if password is None:
