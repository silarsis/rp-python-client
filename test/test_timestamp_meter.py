...
from swagger_client.models.timestamp_meter import TimestampMeter


class TestTimestampMeter(unittest.TestCase):
    """ TimestampMeter unit test stubs """
    ...
    def testTimestampMeter(self):
        """
        Test TimestampMeter
        """
        model = swagger_client.models.timestamp_meter.TimestampMeter()
